            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mt-4">
                            <form class="forms-sample"action="{{ route('brandlogo.update',$data->id) }}" method="POST"
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="file" class="form-control dropify @error('image') is-invalid @enderror"
                                        id="image" name="image"
                                        data-default-file="{{ isset($data) && $data->image ? asset($data->image) : asset('backend/images/placeholder/image_placeholder.png') }}"
