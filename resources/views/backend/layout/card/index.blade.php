    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Card Packages</h4>
                        <div style="display: flex;justify-content: end;"><a href="{{ route('card.create') }}"
                                class="btn btn-primary">Card Plan Packages</a></div>
